...
connection_url = 'mongodb+srv://wichukorn:Tone1993@cluster0.t2xd4.mongodb.net/myFirstDatabase?retryWrites=true&w=majority'
app = Flask(__name__)
client = pymongo.MongoClient(connection_url)
  
# Database
Database = client.get_database('SMM')
# Table
SampleTable = Database.user
